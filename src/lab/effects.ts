...
export const categories: Category[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { code: c(2, 'GLS'), name: 'Glass icons', blurb: 'Glassy 3D icon tiles.', source: 'reactbits', component: 'GlassIcons', install: 'reactbits: get GlassIcons (ts-tailwind)', siteTarget: 'Socials row', props: { className: '!py-0 !gap-6 !grid-cols-[auto_auto]', items: [{ icon: '★', color: 'indigo', label: 'GitHub' }, { icon: '✉', color: 'green', label: 'Email' }] } },
